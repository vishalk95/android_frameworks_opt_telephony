...
public interface MtkRILConstants extends RILConstants {
    ...
    /// @}
    public static final int DATA_PROFILE_BIP = DATA_PROFILE_OEM_BASE + 12;
    public static final int DATA_PROFILE_VSIM = DATA_PROFILE_OEM_BASE + 13;
    public static final int DATA_PROFILE_ALL = DATA_PROFILE_OEM_BASE + 14;

    /* M: Deactivate data call reasons for ipv6 RA failed feature */
    public static final int DEACTIVATE_REASON_RA_BASE = 2000;
    public static final int DEACTIVATE_REASON_NORMAL = DEACTIVATE_REASON_RA_BASE + 1;
    public static final int DEACTIVATE_REASON_RA_INITIAL_FAIL = DEACTIVATE_REASON_RA_BASE + 2;
    public static final int DEACTIVATE_REASON_NO_PCSCF = DEACTIVATE_REASON_RA_BASE + 3;
    public static final int DEACTIVATE_REASON_RA_REFRESH_FAIL = DEACTIVATE_REASON_RA_BASE + 4;
    ...
    /// M: CC: For 3G VT only @{
    int RIL_REQUEST_VOICE_ACCEPT = RIL_REQUEST_VENDOR_BASE + 31;
    int RIL_REQUEST_VT_DIAL = RIL_REQUEST_VENDOR_BASE + 32;
    int RIL_REQUEST_REPLACE_VT_CALL = RIL_REQUEST_VENDOR_BASE + 33;
    /// @}
    ...
    /// M: CC: For 3G VT only @{
    int RIL_UNSOL_VT_STATUS_INFO = (RIL_UNSOL_VENDOR_BASE + 26);
    /// @}
