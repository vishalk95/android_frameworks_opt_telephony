...
public class LteDcPhoneProxy extends PhoneProxy {
    ...
    protected void switchActivePhone(Phone targetPhone) {
        ...
        mIccCardProxy
                .setVoiceRadioTech(mActivePhone.getPhoneType() == PhoneConstants.PHONE_TYPE_GSM
        ...
        // Update PS Phone
        int oldSs = mActivePhone.getPhoneType() == PhoneConstants.PHONE_TYPE_GSM
                ? ServiceState.RIL_RADIO_TECHNOLOGY_EVDO_A
                : ServiceState.RIL_RADIO_TECHNOLOGY_LTE;
        int newSs = mActivePhone.getPhoneType() == PhoneConstants.PHONE_TYPE_GSM
                ? ServiceState.RIL_RADIO_TECHNOLOGY_LTE
                : ServiceState.RIL_RADIO_TECHNOLOGY_EVDO_A;
    ...
    /**
     * Return the SvlteIrController.
     * @return SvlteIrController
     */
    public SvlteIrController getSvlteIrController() {
        return mSvlteIrController;
    }
